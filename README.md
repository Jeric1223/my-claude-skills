...
| **[blog-post](./blog-post)** | `blog-post@jeric-skills` | 레포의 git 히스토리에서 글로 남길 만한 마찰 지점(삽질·방향 전환·외부 제약)을 찾아 후보를 제안하고, 고른 주제로 실제 화면 캡처가 들어간 기술 블로그 초안과 150자 소개문을 만든 뒤 AI 티를 벗깁니다. 후보를 전부 거절하면 인터뷰로 전환합니다 |
